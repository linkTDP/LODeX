var FilterCond = Stapes.subclass({
    constructor : function(parameter,command,expression){
//		0	<core-item>contain</core-item>
//		1	<core-item>not contain</core-item> FILTER (!regex(?titulo_pelicula, "The Lord of the Rings","i")) 
//		2	<core-item>equal</core-item>    FILTER (str(?name) = "May Robson")
//		3	<core-item>not equal</core-item>  !=
//		4	<core-item>></core-item>
//		5	<core-item>&lt;</core-item>
    ...
    getQueryFilt : function(){
    	...
    	if(this.command == 0 || this.command == 1){
    		...
    		var tmpParamFilt=this.param;
    		var tmpExprFilt=this.expression;
    		if (isNaN(this.expression)){
    			tmpParamFilt="str("+this.param+")";
    			tmpExprFilt='"'+this.expression+'"';
    		}
    		var opString="";
    		if (this.command == 2)opString="=";
    		if (this.command == 3)opString="!=";
    		if (this.command == 4)opString=">";
    		if (this.command == 5)opString="<";
    		tmpFitQ=tmpFitQ+' ('+tmpParamFilt+' '+opString+' '+tmpExprFilt+' ). ';
    	}
    	return tmpFitQ;
    }
    });
...
var AttributeOfAClass = Stapes.subclass({
    ...
    addFilter : function(command,expression){
//		0	<core-item>contain</core-item>
//		1	<core-item>not contain</core-item> FILTER (!regex(?titulo_pelicula, "The Lord of the Rings","i")) 
//		2	<core-item>equal</core-item>    FILTER (str(?name) = "May Robson")
//		3	<core-item>not equal</core-item>  !=
...
//		5	<core-item>&lt;</core-item>
    	...
    	this.filters.push(new FilterCond(this.parameter,command,expression))
    },
    getName : function() {
        return this.name;
    },
...
//				console.log(_.map(this.getnotOptAtr(),function(a){return a.getFiltQuer()}))
    ...
    addFiltCond:function(parName,command,expression){
//		0	<core-item>contain</core-item>
//		1	<core-item>not contain</core-item> FILTER (!regex(?titulo_pelicula, "The Lord of the Rings","i")) 
//		2	<core-item>equal</core-item>    FILTER (str(?name) = "May Robson")
//		3	<core-item>not equal</core-item>  !=
//		4	<core-item>></core-item>
//		5	<core-item>&lt;</core-item>
    	var ind=this.getInxAttrByParam(parName);
    	this.attributes[ind].addFilter(command,expression);
    },
...
var QuerOrchestrator = Stapes.subclass({
    ...
    addFiltCondToPar:function(parName,command,expression){
//		0	<core-item>contain</core-item>
//		1	<core-item>not contain</core-item> FILTER (!regex(?titulo_pelicula, "The Lord of the Rings","i")) 
//		2	<core-item>equal</core-item>    FILTER (str(?name) = "May Robson")
//		3	<core-item>not equal</core-item>  !=
...
//		5	<core-item>&lt;</core-item>
    	...
    	this.classNodes[ind].addFiltCond(parName,command,expression);
    },
    nextPage : function(){
    	this.page+=1;
    },
    ...
    addNode : function(node){
    	...
    	//controllare com'� il nuovo nodo da aggiungere?
...
//    	var inx=getClassInxByClassParam(param);
    ...
    getChilds : function(index){
    	...
    	var curNo = _.find(document.querySelector('lodex-layout').curQCN,function(a){return a.index==index})
    	var lev1Childs = _.compact(_.map(document.querySelector('lodex-layout').curQCN,function(a){if(a.qoQI==curNo.index)return a}))
...
//    	_.each(lev1Childs,function(a){if(!this.isNodeLeaf(a.param))childs.concat(this.getChilds(a.index))})
    ...
    getLevel1Child :function(index){
    	var curNo = _.find(document.querySelector('lodex-layout').curQCN,function(a){return a.index==index})
    	var lev1Childs = _.compact(_.map(document.querySelector('lodex-layout').curQCN,function(a){if(a.qoQI==curNo.index)return a.index}))
    	return lev1Childs;
    },
